          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="order-2 lg:order-1">
              ...
              <form className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto bg-[#d97706] hover:bg-[#b46002] text-white px-10 py-4 rounded-xl font-bold transition-all duration-300 shadow-md active:scale-95"
                >
                  Submit Inquiry
                </button>
              </form>
...
{ city: "Indore, India" }
      ...
      <img src={bgchatboat}   className="d-none img-fluid"/>

      {/* CTA SECTION - Mobile stacking optimized */}
      <section className="bg-[#0B2341] text-white py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl">
            <h3 className="text-xl font-bold mb-2">Win with AI</h3>
            <p className="text-gray-300 text-sm mb-6">
              Transform your investment operations with our custom AI engines.
            </p>
            <button className="w-full md:w-auto bg-[#d97706] px-8 py-3 rounded-lg font-bold">
              See How
            </button>
          </div>
